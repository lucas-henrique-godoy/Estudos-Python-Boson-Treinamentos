...
# Imprime o valor arredondado com duas casas decimais: 'O valor é: 125.58'. Usando :.2f
...
valor = 125.579637
print(f'O valor é: \'{valor:.2f}\'')  
# Imprime o valor entre aspas simples usando o caractere de escape \': 'O valor é: '125.58''. Aqui a intenção foi mostrar também as aspas junto com o valor..
# Caso seja necessário mostrar numa situação o caractere de \ é só usar \\ para mostrar 1 barra.

#____________________________________________________________________________________________________________________________________________________________

# CARACTERE DE ESCAPE - TABULAÇÃO(TAB DO TECLADO) \t: uso do caractere de escape \t para tabulação. Dando assim espaço entre os elementos.
nome = 'Lucas'
idade = 26
